...
" <space>y to trigger recent yanks List
nnoremap <silent> <space>y  :<C-u>CocList -A --normal yank<cr>

" <space>p to show Problems
nnoremap <silent> <space>p  :CocDiagnostics<cr>

" Navigate diagnostics
nmap <silent> <C-k> <Plug>(coc-diagnostic-prev)
nmap <silent> <C-j> <Plug>(coc-diagnostic-next)

" Add :Prettier command from coc-prettier
command! -nargs=0 Prettier :CocCommand prettier.formatFile
nmap <leader>p  :Prettier<CR>

" Format whole file on ff
...
nnoremap <leader>vf :call VitestCurrent()<CR>
